...
&hm LGUI A,        &hm LALT R,        &hm LCTRL S,       &sm LSHFT T, &hm LC(LG(LS(LALT))) G, &hm LC(LG(LS(LALT))) M,             &sm LSHFT N,       &hm LCTRL E,       &hm LALT I,        &hm LGUI O,        \
&lt U_BUTTON Z,    &hm GLOBE X,       &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         &hm GLOBE DOT,      &lt U_BUTTON SLASH,\
...
&kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_NA,              U_NA,              &kp F14,           &kp F15,          &u_bt_sel_4,        &u_bt_sel_5,        \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp C_PP,          &u_ep_tog,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
